...
var createOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                order = new Order_1.default(req.body);
            ...
            case 2:
                error_1 = _a.sent();
                res.status(500).json({ error: getErrorMessage(error_1) });
                return [3 /*break*/, 3];
...
var getOrders = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Order_1.default.find().sort({ createdAt: -1 })];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
                res.status(500).json({ error: getErrorMessage(error_2) });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var getOrderById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_3 = _a.sent();
                res.status(500).json({ error: getErrorMessage(error_3) });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var updateOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Order_1.default.findByIdAndUpdate(req.params.id, req.body, { new: true })];
            case 1:
                order = _a.sent();
                if (!order) {
                    res.status(404).json({ error: "Order not found" });
            ...
            case 2:
                error_4 = _a.sent();
                res.status(500).json({ error: getErrorMessage(error_4) });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var deleteOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Order_1.default.findByIdAndDelete(req.params.id)];
            case 1:
                order = _a.sent();
                if (!order) {
                    res.status(404).json({ error: "Order not found" });
            ...
            case 2:
                error_5 = _a.sent();
                res.status(500).json({ error: getErrorMessage(error_5) });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
