...
var SendEmails_1 = require("../utils/SendEmails");
var router = (0, express_1.Router)();
router.post("/send-otp", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var email, otp, sent, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                otp = (0, OTPGenerator_1.generateOTP)(6);
                return [4 /*yield*/, (0, SendEmails_1.sendOTP)(email, otp)];
            case 1:
                sent = _a.sent();
                if (!sent) {
